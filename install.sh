...
DEFAULT_PYTHON_SDK_INSTALL_VERSION="${MN_DEFAULT_PYTHON_SDK_VERSION:-v1.2.23}"
DEFAULT_CLI_INSTALL_VERSION="${MN_DEFAULT_CLI_VERSION:-v1.2.23}"
DEFAULT_API_INSTALL_VERSION="${MN_DEFAULT_API_VERSION:-v1.2.23}"
DEFAULT_WEB_UI_INSTALL_VERSION="${MN_DEFAULT_WEB_UI_VERSION:-v1.2.23}"
CORE_ASSET_URL="${MN_CORE_ASSET_URL:-}"
MN_PACKAGE_VERSION=""
