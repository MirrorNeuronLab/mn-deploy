...
MN_DEFAULT_CORE_VERSION="${MN_DEFAULT_CORE_VERSION:-v1.3.55}"
# SDK, CLI, and API are pip packages.
MN_DEFAULT_PYTHON_SDK_VERSION="${MN_DEFAULT_PYTHON_SDK_VERSION:-v1.3.51}"
MN_DEFAULT_CLI_VERSION="${MN_DEFAULT_CLI_VERSION:-v1.3.52}"
MN_DEFAULT_API_VERSION="${MN_DEFAULT_API_VERSION:-v1.3.51}"
# Web UI is a GAR npm package (the installer strips the leading `v`).
MN_DEFAULT_WEB_UI_VERSION="${MN_DEFAULT_WEB_UI_VERSION:-v1.3.55}"
# Additional pip packages are selected from the versioned package index.
MN_DEFAULT_AGENT_PACKAGE_INDEX_VERSION="${MN_DEFAULT_AGENT_PACKAGE_INDEX_VERSION:-v1.3.55}"
# Membrane context engine is a GAR Docker image.
MN_DEFAULT_MEMBRANE_CONTEXT_ENGINE_VERSION="${MN_DEFAULT_MEMBRANE_CONTEXT_ENGINE_VERSION:-v1.3.55}"
...
MN_DEFAULT_INSTALL_VERSION="${MN_DEFAULT_INSTALL_VERSION:-v1.3.55}"
...
case "$MN_INSTALL_MODE" in
    local) MN_USE_LOCAL_SKILLS="${MN_USE_LOCAL_SKILLS:-1}" ;;
    github|binary) MN_USE_LOCAL_SKILLS="${MN_USE_LOCAL_SKILLS:-0}" ;;
esac
export MN_USE_LOCAL_SKILLS
...
MN_ENV=${MN_ENV:-prod}
MN_USE_LOCAL_SKILLS=${MN_USE_LOCAL_SKILLS}
